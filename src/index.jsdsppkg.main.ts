...
const Unary = generateRemoteObject(_Unary as typeof BaseObject);
const Binary = generateRemoteObject(_Binary as typeof BaseObject);
const Ternary = generateRemoteObject(_Ternary as typeof BaseObject);
const ArrUnary = generateRemoteObject(_ArrUnary as typeof BaseObject);
const ArrBinary = generateRemoteObject(_ArrBinary as typeof BaseObject);
const ArrTernary = generateRemoteObject(_ArrTernary as typeof BaseObject);
