...
const ArrUnary = generateRemotedObject(_ArrUnary as typeof BaseObject);
const ArrBinary = generateRemotedObject(_ArrBinary as typeof BaseObject);
const ArrTernary = generateRemotedObject(_ArrTernary as typeof BaseObject);
